...
export PFNGLCLEARBUFFERFIPROC glClearBufferfi;
...
export PFNGLCLEARNAMEDFRAMEBUFFERFIPROC glClearNamedFramebufferfi;
...
export PFNGLPATHCOMMANDSNVPROC glPathCommandsNV;
export PFNGLSTENCILFILLPATHNVPROC glStencilFillPathNV;
export PFNGLCOVERFILLPATHNVPROC glCoverFillPathNV;
export PFNGLSTENCILSTROKEPATHNVPROC glStencilStrokePathNV;
export PFNGLCOVERSTROKEPATHNVPROC glCoverStrokePathNV;
export PFNGLSTENCILFUNCPROC glStencilFunc;
export PFNGLSTENCILOPPROC glStencilOp;
export PFNGLPATHPARAMETERFNVPROC glPathParameterfNV;
export PFNGLPATHPARAMETERINVPROC glPathParameteriNV;
...
#define GET_PROC(type, name) \
  ...
  GET_PROC(PFNGLCLEARBUFFERFIPROC, glClearBufferfi);
  ...
  GET_PROC(PFNGLCLEARNAMEDFRAMEBUFFERFIPROC, glClearNamedFramebufferfi);
  ...
  GET_PROC(PFNGLPATHCOMMANDSNVPROC, glPathCommandsNV);
  GET_PROC(PFNGLSTENCILFILLPATHNVPROC, glStencilFillPathNV);
  GET_PROC(PFNGLCOVERFILLPATHNVPROC, glCoverFillPathNV);
  GET_PROC(PFNGLSTENCILSTROKEPATHNVPROC, glStencilStrokePathNV);
  GET_PROC(PFNGLCOVERSTROKEPATHNVPROC, glCoverStrokePathNV);
  GET_PROC(PFNGLSTENCILFUNCPROC, glStencilFunc);
  GET_PROC(PFNGLSTENCILOPPROC, glStencilOp);
  GET_PROC(PFNGLPATHPARAMETERFNVPROC, glPathParameterfNV);
  GET_PROC(PFNGLPATHPARAMETERINVPROC, glPathParameteriNV);
